...
const ANLAUT_BILDER = {
  'A':   ['A-Affe', 'A-Apfel', 'A-Arm', 'A-Ananas'],
  'Au':  ['Au-Auto'],
  'Ä':   ['Ä-Ähre', 'Ä-Ärmel'],
  'B':   ['B-Baum', 'B-Bett', 'B-Biene', 'B-Bus', 'B-Banane'],
  'C':   ['C-Clown', 'C-Computer'],
  'D':   ['D-Dach', 'D-Daumen', 'D-Dino', 'D-Dose'],
  'E':   ['E-Elefant', 'E-Engel', 'E-Esel', 'E-Ente', 'E-Erdbeere'],
  'Ei':  ['Ei-Eimer', 'Ei-Eis', 'Ei-Ei'],
  'Eu':  ['Eu-Eule', 'Eu-Euter'],
  'F':   ['F-Fahrrad', 'F-Feder', 'F-Fenster', 'F-Fisch', 'F-Fußball', 'F-Football'],
  'G':   ['G-Gabel', 'G-Geschenk', 'G-Giraffe', 'G-Glas'],
  'H':   ['H-Hammer', 'H-Hand', 'H-Hut', 'H-Haus'],
  ...
  'O':   ['O-Ohr', 'O-Orange'],
  'Ö':   ['Ö-Öffner', 'Ö-Öl'],
  'P':   ['P-Pferd', 'P-Pilz', 'P-Pinsel', 'P-Pirat', 'P-Pinguin'],
  'Q':   ['Q-Qualle'],
  'R':   ['R-Rakete', 'R-Regenbogen', 'R-Ring', 'R-Rose', 'R-Radiergummi'],
  'S':   ['S-Seife', 'S-Socken', 'S-Sonne'],
  'Sch': ['Sch-Schaf', 'Sch-Schere', 'Sch-Schuh', 'Sch-Schnecke', 'Sch-Schildkröte'],
  'Sp':  ['Sp-Spiegel', 'Sp-Spinne', 'Sp-Spitzer'],
  'St':  ['St-Stern', 'St-Staubsauger', 'St-Stuhl', 'St-Stift'],
  'T':   ['T-Tiger', 'T-Tisch', 'T-Tischtennis'],
  'U':   ['U-Uboot', 'U_Uhr'],
  'Ü':   ['Ü-Überholverbot'],
  'V':   ['V-Vase', 'V-Vogel'],
